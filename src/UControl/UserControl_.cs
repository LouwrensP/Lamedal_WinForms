...
namespace Lamedal_UIWinForms.UControl
{
    ...
    public partial class UserControl_ : UserControl
    {
        ...
        protected void Control_Dock(DockStyle dockStyle = DockStyle.Top, params Type[] ifParentIsInThisTypes)
        {
            if (Form_IsParentFormLoaded() == false) return;
        ...
        /// </summary>
        /// <param name="dockStyle">The dock style.</param>
        protected void Control_DockInPanel(DockStyle dockStyle = DockStyle.Top)
        {
            Control_Dock(dockStyle, typeof(Panel), typeof(GroupBox));
        }
        ...
        protected bool Form_IsParentFormLoaded(bool showMsg = false)
        {
            if (ParentForm == null)
            {
        ...
        protected bool Control_IsHostedInDesigner()
        {
        ...
        /// <returns></returns>
        protected bool Form_IsParentFormTheMainForm(Control control = null)
        {
        ...
        /// <returns></returns>
        protected List<Component> Components_FromControls(IList forTheseControls = null, params Type[] filterForTypes)
        {
            if (forTheseControls == null) forTheseControls = this.Controls;
            return IamWindows.libUI.WinForms.Controls.Control.FindComponents(forTheseControls, false, filterForTypes);
        }
        ...
        /// <param name="filterForTypes">The filter for types.</param>
        /// <returns></returns>
        protected List<Component> Components_FromParent(Control parent, params Type[] filterForTypes)
        {
            if (!Form_IsParentFormLoaded()) return null;
            return IamWindows.libUI.WinForms.Controls.Control.FindComponents(parent, false, filterForTypes);
        }
        ...
        /// <param name="filterForTypes">The filter for types.</param>
        /// <returns></returns>
        protected List<Component> Components_FromParentForm(params Type[] filterForTypes)
        {
            if (!Form_IsParentFormLoaded()) return null;

            Form frmParent = this.ParentForm;
            return IamWindows.libUI.WinForms.Controls.Control.FindComponents(frmParent, false, filterForTypes);
        }
